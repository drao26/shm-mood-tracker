...
themes are generated by gemini 1.5 flash (free tier). without setup, the app
...
free tier limits: 15 req/min, 1500 req/day on gemini-1.5-flash. with 3 users
and weekly refresh that's ~12 calls/month — well within limits.

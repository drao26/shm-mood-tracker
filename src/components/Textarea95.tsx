...
export default function Textarea95({ className = '', ...props }: Textarea95Props) {
  return (
    <textarea
      className={`border-2 border95-inset bg-white text-[12px] p-1 resize-y min-h-[60px] w-full outline-none focus:[outline:1px_dotted_var(--focus-dot)] focus:[outline-offset:-3px] ${className}`}
